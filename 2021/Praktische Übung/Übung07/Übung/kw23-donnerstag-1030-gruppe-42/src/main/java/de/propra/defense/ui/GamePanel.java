...
public class GamePanel extends JFrame {
  ...
  private final Map<String, Image> units = new HashMap<>();
  ...
  private void loadUnitTiles(MediaTracker tracker) {
    units.put("FROG", load(5, tracker, "frog.jpg"));
    units.put("BUG1", load(6, tracker, "bug1.jpg"));
    units.put("BUG2", load(7, tracker, "bug_s.png"));
    units.put("CROW", load(8, tracker, "crow_s.png"));
    units.put("SCARECROW", load(9, tracker, "scarecrow.jpg"));
    units.put("PLANT", load(10, tracker, "plant.jpg"));
  }
  ...
  public void placeUnit(String unit, int row, int col) {
